      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            ...
            and marketplace listings. <strong className="text-green-400">Powered by OpenAI DALL-E 2</strong> - intelligently edits your product photos to create professional packshots with studio lighting and clean backgrounds.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
            <div className="text-3xl mb-3">⚡</div>
            <h3 className="text-lg font-semibold mb-2">OpenAI DALL-E 2 Edit</h3>
            <p className="text-sm text-gray-400">
              Intelligent image editing that transforms backgrounds while preserving your product's appearance and details
            </p>
          </div>
          <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
            <div className="text-3xl mb-3">💎</div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-gradient-to-br from-emerald-900/20 to-green-900/20 rounded-xl border border-emerald-700/50 p-6">
            ...
            <div className="space-y-3 text-gray-300">
              <div>
                <strong className="text-white">OpenAI DALL-E 2 Technology:</strong> Advanced AI image editing that understands context and preserves product integrity while transforming backgrounds
              </div>
              <div>
                <strong className="text-white">Professional Results:</strong> Studio-quality lighting, clean backgrounds (white, gray, beige, blue), and natural shadows - all generated by AI
              </div>
              <div>
              ...
              <div>
                <strong className="text-white">Fast & Affordable:</strong> Professional-grade results in 10-20 seconds, only 2 credits per packshot
              </div>
            </div>
          </div>
        </div>
