          ...
          <div className="relative text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600 dark:text-green-400">{t('stats.outputSize')}</div>
                <div className="text-sm text-gray-500">{t('stats.outputSizeLabel')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{t('stats.processing')}</div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-green-100 dark:from-green-900/20 to-emerald-100 dark:to-emerald-900/20 rounded-xl border border-gray-200 dark:border-green-700/50 p-6">
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('backgroundOptions.white.title')}</strong> {t('backgroundOptions.white.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('backgroundOptions.lightGray.title')}</strong> {t('backgroundOptions.lightGray.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('backgroundOptions.beige.title')}</strong> {t('backgroundOptions.beige.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('backgroundOptions.lightBlue.title')}</strong> {t('backgroundOptions.lightBlue.description')}
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-100 dark:from-emerald-900/20 to-green-100 dark:to-green-900/20 rounded-xl border border-gray-200 dark:border-emerald-700/50 p-6">
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('featuresIncluded.aiTechnology.title')}</strong> {t('featuresIncluded.aiTechnology.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('featuresIncluded.professionalResults.title')}</strong> {t('featuresIncluded.professionalResults.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('featuresIncluded.highQuality.title')}</strong> {t('featuresIncluded.highQuality.description')}
                </div>
                <div>
                  <strong className="text-gray-900 dark:text-white">{t('featuresIncluded.fast.title')}</strong> {t('featuresIncluded.fast.description')}
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-green-500/50 transition">
              ...
              <div className="text-xs text-green-600 dark:text-green-400">{t('useCases.ecommerce.detail')}</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-green-500/50 transition">
              ...
              <div className="text-xs text-green-600 dark:text-green-400">{t('useCases.dropshippers.detail')}</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-green-500/50 transition">
              <div className="text-3xl mb-3">📱</div>
              ...
              <div className="text-xs text-green-600 dark:text-green-400">{t('useCases.socialMedia.detail')}</div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 mb-16">
          <div className="bg-gray-100 dark:bg-gray-800/20 rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-green-600 dark:text-green-400 mb-3">{t('tips.bestPractices.title')}</h4>
              ...
              <div>
                <h4 className="font-semibold text-emerald-600 dark:text-emerald-400 mb-3">{t('tips.proTips.title')}</h4>
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <li className="flex items-start gap-2">
