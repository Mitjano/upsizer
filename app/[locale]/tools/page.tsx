...
const toolsData = [
  {
    ...
    cardClass: 'bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-blue-200 dark:border-blue-700/30',
    credits: '1 credit',
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-700/30',
    credits: '1 credit',
    aiModel: 'Real-ESRGAN',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-purple-200 dark:border-purple-700/30',
    credits: '2 credits',
    aiModel: 'FLUX Fill',
  },
  {
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 border-cyan-200 dark:border-cyan-700/30',
    credits: '1 credit',
    aiModel: 'Real-ESRGAN',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-orange-200 dark:border-orange-700/30',
    credits: '2 credits',
    aiModel: 'BRIA Eraser',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-700/30',
    credits: '2 credits',
    aiModel: 'DALL-E 2',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 border-pink-200 dark:border-pink-700/30',
    credits: '3 credits',
    aiModel: 'BRIA AI',
  },
  {
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-amber-200 dark:border-amber-700/30',
    credits: '3 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 border-violet-200 dark:border-violet-700/30',
    credits: '2 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border-teal-200 dark:border-teal-700/30',
    credits: '3 credits',
    aiModel: 'FLUX Depth',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 border-rose-200 dark:border-rose-700/30',
    credits: '3 credits',
    aiModel: 'FLUX Fill',
  },
];
