...
const toolsData = [
  {
    ...
    cardClass: 'bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/50 dark:to-cyan-950/30 border-blue-200 dark:border-blue-500/50',
    iconBg: 'bg-gradient-to-br from-blue-500/20 to-cyan-500/20 dark:from-blue-500/40 dark:to-cyan-500/40',
    hoverGlow: 'dark:hover:shadow-blue-500/20',
    credits: '1 credit',
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/50 dark:to-pink-950/30 border-purple-200 dark:border-purple-500/50',
    iconBg: 'bg-gradient-to-br from-purple-500/20 to-pink-500/20 dark:from-purple-500/40 dark:to-pink-500/40',
    hoverGlow: 'dark:hover:shadow-purple-500/20',
    credits: '1-3 credits',
    aiModel: 'Real-ESRGAN',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/50 dark:to-indigo-950/30 border-purple-200 dark:border-indigo-500/50',
    iconBg: 'bg-gradient-to-br from-purple-500/20 to-indigo-500/20 dark:from-purple-500/40 dark:to-indigo-500/40',
    hoverGlow: 'dark:hover:shadow-indigo-500/20',
    credits: '2 credits',
    aiModel: 'FLUX Fill',
  },
  {
    ...
    href: '/tools/colorize',
    color: 'from-purple-500 to-pink-500',
    cardClass: 'bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/50 dark:to-pink-950/30 border-purple-200 dark:border-pink-500/50',
    iconBg: 'bg-gradient-to-br from-purple-500/20 to-pink-500/20 dark:from-purple-500/40 dark:to-pink-500/40',
    hoverGlow: 'dark:hover:shadow-pink-500/20',
    credits: '1 credit',
    aiModel: 'DeOldify AI',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/50 dark:to-blue-950/30 border-cyan-200 dark:border-cyan-500/50',
    iconBg: 'bg-gradient-to-br from-cyan-500/20 to-blue-500/20 dark:from-cyan-500/40 dark:to-blue-500/40',
    hoverGlow: 'dark:hover:shadow-cyan-500/20',
    credits: '1 credit',
    aiModel: 'Real-ESRGAN',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/50 dark:to-red-950/30 border-orange-200 dark:border-orange-500/50',
    iconBg: 'bg-gradient-to-br from-orange-500/20 to-red-500/20 dark:from-orange-500/40 dark:to-red-500/40',
    hoverGlow: 'dark:hover:shadow-orange-500/20',
    credits: '2 credits',
    aiModel: 'BRIA Eraser',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/30 border-green-200 dark:border-green-500/50',
    iconBg: 'bg-gradient-to-br from-green-500/20 to-emerald-500/20 dark:from-green-500/40 dark:to-emerald-500/40',
    hoverGlow: 'dark:hover:shadow-green-500/20',
    credits: '2 credits',
    aiModel: 'DALL-E 2',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-950/50 dark:to-purple-950/30 border-pink-200 dark:border-pink-500/50',
    iconBg: 'bg-gradient-to-br from-pink-500/20 to-purple-500/20 dark:from-pink-500/40 dark:to-purple-500/40',
    hoverGlow: 'dark:hover:shadow-pink-500/20',
    credits: '3 credits',
    aiModel: 'BRIA AI',
  },
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/50 dark:to-orange-950/30 border-amber-200 dark:border-amber-500/50',
    iconBg: 'bg-gradient-to-br from-amber-500/20 to-orange-500/20 dark:from-amber-500/40 dark:to-orange-500/40',
    hoverGlow: 'dark:hover:shadow-amber-500/20',
    credits: '3 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-950/50 dark:to-purple-950/30 border-violet-200 dark:border-violet-500/50',
    iconBg: 'bg-gradient-to-br from-violet-500/20 to-purple-500/20 dark:from-violet-500/40 dark:to-purple-500/40',
    hoverGlow: 'dark:hover:shadow-violet-500/20',
    credits: '2 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/50 dark:to-cyan-950/30 border-teal-200 dark:border-teal-500/50',
    iconBg: 'bg-gradient-to-br from-teal-500/20 to-cyan-500/20 dark:from-teal-500/40 dark:to-cyan-500/40',
    hoverGlow: 'dark:hover:shadow-teal-500/20',
    credits: '3 credits',
    aiModel: 'FLUX Depth',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/50 dark:to-pink-950/30 border-rose-200 dark:border-rose-500/50',
    iconBg: 'bg-gradient-to-br from-rose-500/20 to-pink-500/20 dark:from-rose-500/40 dark:to-pink-500/40',
    hoverGlow: 'dark:hover:shadow-rose-500/20',
    credits: '3 credits',
    aiModel: 'FLUX Fill',
  },
];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tools.map((tool) => (
              <Link
                key={tool.id}
                href={tool.href}
                className={`group ${tool.cardClass} rounded-xl border p-6 hover:border-gray-400 dark:hover:border-gray-400 transition-all hover:scale-[1.02] hover:shadow-xl shadow-sm ${tool.hoverGlow || ''}`}
              >
