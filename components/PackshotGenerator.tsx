...
const PRESETS: Preset[] = [
  ...
  },
  {
    id: 'lifestyle',
    name: 'Lifestyle',
    description: 'Modern interior scene',
    icon: '🏠',
    credits: CREDIT_COSTS.packshot.cost,
  },
]
...
export function PackshotGenerator({ userRole = 'user' }: PackshotGeneratorProps) {
  ...
  const onDrop = useCallback(
    ...
    [selectedPreset, customPrompt, useCustomPrompt]
  )
      ...
      {!result && (
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {processing ? (
              <>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Generating AI background...</h3>
                <div className="flex justify-center">
                  <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-500"></div>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">This may take 15-30 seconds</p>
              </>
            ) : (
              <>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  Supports JPG, PNG, WEBP • Max 30MB • {CREDIT_COSTS.packshot.cost} credit
                </p>
              </>
            )}
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <p className="text-green-800 dark:text-green-300 text-sm">
              ✨ AI background generated successfully! You have{' '}
