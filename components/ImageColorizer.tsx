      ...
      <div className="max-w-6xl mx-auto">
        <div className="relative border-2 border-dashed border-gray-600 rounded-2xl p-12 bg-gray-800/30">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold mb-3">Sign in to Colorize Images</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              Create a free account to start colorizing your black & white photos with AI.
            </p>
            <div className="flex gap-4 justify-center">
              <a href="/auth/signin" className="inline-block px-8 py-3 bg-purple-500 hover:bg-purple-600 rounded-lg font-medium transition">
                Sign In
              </a>
