  ...
  return (
    <section className="container mx-auto px-4 py-20 bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-black">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {/* Bulk Transformation */}
        <div className="bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 hover:border-purple-500 transition-all">
          ...
          <div className="bg-gray-100/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-500 dark:text-gray-400">{t('bulk.stats.speed')}</span>
              <span className="text-sm font-semibold text-purple-500 dark:text-purple-400">~10s {t('bulk.stats.perImage')}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">{t('bulk.stats.maxBatch')}</span>
              <span className="text-sm font-semibold text-purple-500 dark:text-purple-400">{t('bulk.stats.unlimited')}</span>
            </div>
          </div>
        </div>

        {/* API Integration */}
        <div className="bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 hover:border-pink-500 transition-all">
      ...
      <div className="grid md:grid-cols-4 gap-6 mt-12 max-w-6xl mx-auto">
        <div className="bg-gray-100/30 dark:bg-gray-800/30 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          ...
          <h4 className="font-semibold mb-2">{t('features.secure.title')}</h4>
          <p className="text-sm text-gray-500 dark:text-gray-400">{t('features.secure.description')}</p>
        </div>

        <div className="bg-gray-100/30 dark:bg-gray-800/30 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-3xl mb-3">⚡</div>
          <h4 className="font-semibold mb-2">{t('features.fast.title')}</h4>
          <p className="text-sm text-gray-500 dark:text-gray-400">{t('features.fast.description')}</p>
        </div>

        <div className="bg-gray-100/30 dark:bg-gray-800/30 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-3xl mb-3">📊</div>
          <h4 className="font-semibold mb-2">{t('features.analytics.title')}</h4>
          <p className="text-sm text-gray-500 dark:text-gray-400">{t('features.analytics.description')}</p>
        </div>

        <div className="bg-gray-100/30 dark:bg-gray-800/30 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-3xl mb-3">💬</div>
          <h4 className="font-semibold mb-2">{t('features.support.title')}</h4>
          <p className="text-sm text-gray-500 dark:text-gray-400">{t('features.support.description')}</p>
        </div>
      </div>
